...
module.exports = __webpack_require__("iqI4");
...
async function handler(req, res) {
  if (req.method === "POST") {
    ...
    const client = await Object(_lib_db__WEBPACK_IMPORTED_MODULE_0__[/* connectToDatabase */ "a"])();
    const db = client.db();
    ...
    try {
      const data = await Object(_lib_db__WEBPACK_IMPORTED_MODULE_0__[/* getAllPosts */ "c"])();
