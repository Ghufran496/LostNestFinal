...
function PostNewItem() {
  ...
  const postSubmitHandler = async (event) => {
    ...
    const message = `Welcome to LostNest
      ...
      <form onSubmit={postSubmitHandler}>
        <div className="space-y-12">
          <div className="border-b border-gray-900/10 pb-12">
            <h2 className="text-xl font-semibold leading-7 text-gray-900 text-3xl">
              Lost an Item??
            </h2>
                ...
                <div className="sm:col-span-3">
                  ...
                  <div className="mt-2">
                    <select
                      ...
                      ref={typeInputRef}
                      className="block w-full rounded-md border-0 py-4 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:max-w-xs sm:text-sm sm:leading-6"
                    >
            ...
            <div className="mt-2 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
              ...
              <div className="col-span-full">
                ...
                <p className="mt-3 text-lg leading-6 text-gray-600 font-semibold">
                Make sure the image you upload doesn't reveal the answer to the security question.
                </p>
              </div>
            </div>
            {fileError && (
