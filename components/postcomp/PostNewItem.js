...
<form onSubmit={postSubmitHandler}>
  <div className="space-y-12">
    <div className="border-b border-gray-900/10 pb-12">
      <h2 className="text-xl font-semibold leading-7 text-gray-900 text-3xl">Lost an Item??</h2>
      <p className="mt-1 text-sm leading-6 text-gray-600">This information will be displayed publicly so be careful what you share.</p>
      <div className="border-b border-gray-900/10 pb-12">
      
      <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
       <div className="sm:col-span-3">
          <label htmlFor="Lost" className="block text-lg font-medium leading-6 text-gray-900">Item type</label>
          <div className="mt-2">
            <select id="Lost" name="Lost" autoComplete="lost-name" ref={typeInputRef} className="block w-full rounded-md border-0 py-4 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:max-w-xs sm:text-sm sm:leading-6">
        ...
        <div className="sm:col-span-3">
          ...
          <div className="mt-2">
            <input type="text" style={{ fontSize: '10px' }} name="Itemname" id="Itemname" autoComplete="given-name" ref={titleInputRef} className="block w-full rounded-md border-0 py-2.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" required></input>
          </div>
        </div>
      ...
      <div className="mt-2 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
        ...
        <div className="col-span-full">
          ...
          <div className="mt-2">
            <textarea id="about" name="Description" rows="3" style={{ fontSize: '10px' }} ref={descriptionInputRef} className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" required></textarea>
          </div>
