        ...
        <div className={classes.userviewcontent}>
          <div className={classes.userviewformcontainer}>
            ...
            <div className={classes.formgroup}>
                ...
                <input id="id" className={`${classes.forminput} ${classes.updateName}`} type="text" value={props.id} required name="id" readOnly/>
              </div>
              <div className={classes.formgroup}>
                <label className={classes.formlabel} htmlFor="name">Name</label>
                <input id="name" className={`${classes.forminput} ${classes.updateName}`} type="text" value={props.name} required name="name" readOnly/>
              </div>
              <div className={`${classes.formgroup} ${classes.mabtmd}`}>
                <label className={classes.formlabel} htmlFor="email">Email address</label>
                <input id="email" className={`${classes.forminput} ${classes.updateEmail}`} type="email" value={props.email} required name="email" readOnly/>
              </div>
